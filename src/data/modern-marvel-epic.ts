...
// columns -- "TBC" (not yet solicited) reads as blank. Wikipedia doesn't
// give a per-volume synopsis, so description is left blank for every
// volume here -- same known-gap treatment as everywhere else in this app.
...
export const MODERN_MARVEL_LINES: Line[] = [
  {
    ...
    name: "All-New Wolverine",
    iconUrl: modernIcon("laura kinny.png"),
    colorHex: "#B8860B", // reused from classic-marvel-epic Wolverine -- no title-lettering legend given for this line
    // Laura Kinney (X-23)'s first comic appearance: NYX #3, cover-dated Feb 2004
  ...
  },
  {
    ...
    colorHex: "#C0392B", // from Wikipedia title-lettering legend (Red) -- matches classic-marvel-epic's ASM red
    // same character as classic-marvel-epic's Amazing Spider-Man -- reused debut
  ...
  },
  {
    ...
    colorHex: "#BE2946", // from Wikipedia title-lettering legend (Red)
    // same character as classic-marvel-epic's Black Widow -- reused debut
  ...
  },
  {
    ...
    colorHex: "#0B9ED1", // from Wikipedia title-lettering legend (Light blue)
    // same character as classic-marvel-epic's Captain America -- reused debut
  ...
  },
  {
    ...
    colorHex: "#A81F1F", // reused from classic-marvel-epic Carnage -- no title-lettering legend given for this line
    // same character as classic-marvel-epic's Carnage -- reused debut
  ...
  },
  {
    ...
    colorHex: "#6B1F1F", // from Wikipedia title-lettering legend (Dark red) -- matches classic-marvel-epic's Daredevil
    // same character as classic-marvel-epic's Daredevil -- reused debut
    debutDate: { year: 1964, month: 4 },
  },
  {
    id: "dark-avengers",
    ...
    colorHex: "#A4218E", // from Wikipedia title-lettering legend (Purple)
    // FALLBACK: team of villains posing as Avengers, no single character -- Dark Avengers #1, Mar 2009
    debutDate: { year: 2009, month: 3 },
  },
  {
  ...
  },
  {
    ...
    colorHex: "#C0602E", // reused from classic-marvel-epic Deadpool -- Wikipedia gives only the literal word "red" for this legend
    // same character as classic-marvel-epic's Deadpool -- reused debut
  ...
  },
  {
    ...
    colorHex: "#039DD9", // from Wikipedia title-lettering legend (Light blue)
    // same team as classic-marvel-epic's Guardians of the Galaxy -- reused debut
  ...
  },
  {
    ...
    colorHex: "#91288D", // from Wikipedia title-lettering legend (Purple)
    // same character as classic-marvel-epic's Hawkeye -- reused debut
  ...
  },
  {
    ...
    colorHex: "#8CC744", // from Wikipedia title-lettering legend (Green)
    // same character as classic-marvel-epic's Incredible Hulk -- reused debut
  ...
  },
  {
    ...
    colorHex: "#F5C735", // from Wikipedia title-lettering legend (Yellow)
    // same character as classic-marvel-epic's Iron Man -- reused debut
  ...
  },
  {
    ...
    colorHex: "#6B7C43", // from Wikipedia title-lettering legend (Green)
    // Loki's first comic appearance: Journey Into Mystery #85, cover-dated Oct 1962
    debutDate: { year: 1962, month: 10 },
  },
  {
    ...
    colorHex: "#9D353C", // from Wikipedia title-lettering legend (Red)
    // Miles Morales's first comic appearance: Ultimate Fallout #4, cover-dated Aug 2011
    debutDate: { year: 2011, month: 8 },
  },
  {
    id: "new-avengers",
    collectionId: "modern-marvel-epic",
    ...
    colorHex: "#F89D34", // from Wikipedia title-lettering legend (Orange)
    // FALLBACK: Avengers relaunch series, not the team's 1963 debut -- uses this title's own vol. 1 #1 launch, Jan 2005
    debutDate: { year: 2005, month: 1 },
  },
  {
    id: "new-x-men",
    collectionId: "modern-marvel-epic",
  ...
  },
  {
    ...
    colorHex: "#177AB8", // from Wikipedia title-lettering legend (Blue)
    // same character as classic-marvel-epic's Thor -- reused debut
    debutDate: { year: 1962, month: 8 },
  },
  {
    id: "venom-modern",
    ...
    colorHex: "#716E79", // from Wikipedia title-lettering legend (Grey)
    // same character as classic-marvel-epic's Venom -- reused debut
...
export const MODERN_MARVEL_ENTRIES: TimelineEntry[] = [
  ...
  },
  {
    ...
    yearsCovered: "1999, 2004-2005",
    creators: "Straczynski, David",
    // No cover yet -- this volume isn't listed on Amazon or PRH (Wikipedia's own
    // release date for it is a far-future placeholder, "January 2027").
    description:
  ...
  },
  {
    ...
    creators: "",
    // No cover yet -- this Epic Collection edition isn't listed on Amazon or PRH
    // (Wikipedia's own release date for it is a far-future placeholder, "Feb 2027").
    description:
  ...
  },
  {
    ...
    number: "4",
    title: "Conquest",
    // "Years covered" left blank on Wikipedia; estimated as 2007-2008 from surrounding volumes.
    // No cover yet -- this volume isn't listed on Amazon or PRH (Wikipedia's own
    // release date for it is a far-future placeholder, "Jun 2027").
    start: { year: 2007, quarter: 1 },
    end: { year: 2008, quarter: 4 },
  ...
  // --- Daredevil ---
  {
    ...
    // No cover yet -- this Epic Collection edition isn't listed on Amazon or PRH
    // (Wikipedia's own release date for it is a far-future placeholder, "Feb 2027").
    // An older standalone printing of this story exists but isn't the same edition.
    description:
  ...
  },
  {
    ...
    number: "3",
    title: "Evil Deadpool",
    // "Years covered" left blank on Wikipedia; estimated as 2010-2011 from surrounding volumes.
    // No cover yet -- this volume isn't listed on Amazon or PRH.
    start: { year: 2010, quarter: 1 },
    end: { year: 2011, quarter: 4 },
  ...
  },
  {
    ...
    number: "5",
    title: "Dark Reign",
    // "Years covered" left blank on Wikipedia; estimated as 2009 from surrounding volumes.
    start: { year: 2009, quarter: 1 },
    end: { year: 2009, quarter: 4 },
  ...
  },
  {
    ...
    // "Years covered" left blank on Wikipedia; estimated as 2018 from surrounding volumes.
    start: { year: 2018, quarter: 1 },
    end: { year: 2018, quarter: 4 },
