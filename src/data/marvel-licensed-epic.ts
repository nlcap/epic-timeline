...
//
// creators: Wikipedia's Writers column only (surnames) -- Artists aren't
// included here, unlike modern-marvel-epic.ts, since several of these
// tables list 4-7 artists per volume (Dark Horse minis credit differently
// than Marvel's own books) and cramming all of them in reads worse than
// just the writer(s). Star Wars's own Wikipedia tables never listed a
// Writers/Artists column at all (only #/Years/Issues/Pages/Released/ISBN),
// so creators is left empty for every Star Wars volume rather than
// fabricated.
//
// writers/artists: the full credits, backfilled from the same Wikipedia
// tables. Only the 30 non-Star Wars volumes have them, for the reason above
// -- the Star Wars sub-lines still have no creator data to take. releaseDate
// IS available for all 85 (those tables do carry a Released column).
//
...
export const LICENSED_ENTRIES: TimelineEntry[] = [
  // --- Conan the Barbarian ---
  {
    ...
    creators: "Thomas, Windsor-Smith",
    writers: "Roy Thomas",
    artists: "Barry Windsor-Smith",
    description: "",
  ...
  },
  {
    ...
    creators: "Thomas, Buscema, Chaykin",
    writers: "Roy Thomas",
    artists: "John Buscema, Howard Chaykin",
    description: "",
  ...
  // --- Conan Chronicles ---
  {
    ...
    creators: "Busiek, Nicieza, Nord, Yeates, Ruth, Mandrake",
    writers: "Kurt Busiek, Fabian Nicieza",
    artists: "Cary Nord, Thomas Yeates, Greg Ruth, Tom Mandrake",
    description: "",
  ...
  },
  {
    ...
    creators: "Busiek, Mignola, Truman, Nord, Ruth, Lee",
    writers: "Kurt Busiek, Mike Mignola, Timothy Truman",
    artists: "Cary Nord, Greg Ruth, Paul Lee",
    description: "",
  ...
  },
  {
    ...
    creators: "Truman, Busiek, Lee, Nord, Giorello, Ruth, Corben",
    writers: "Timothy Truman, Kurt Busiek",
    artists: "Paul Lee, Cary Nord, Tomas Giorello, Greg Ruth, Richard Corben",
    description: "",
  ...
  },
  {
    ...
    creators: "Truman, Giorello, Kubert, Lee",
    writers: "Timothy Truman",
    artists: "Tomas Giorello, Joe Kubert, Paul Lee",
    description: "",
  ...
  },
  {
    ...
    releaseDate: { year: 2020, month: 6 },
    creators: "Thomas, Wood, Hawthorne, Panosian, Cloonan, Harren",
    writers: "Roy Thomas, Brian Wood",
    artists: "Mike Hawthorne, Dan Panosian, Becky Cloonan, James Harren",
    description: "",
  ...
  },
  {
    ...
    creators: "Wood, Lolos, Shalvey, Colak, Gianfelice, Azaceta, Burchielli",
    writers: "Brian Wood",
    artists: "Vasilis Lolos, Declan Shalvey, Mirko Colak, Davide Gianfelice, Paul Azaceta, Riccardo Burchielli",
    description: "",
  ...
  },
  {
    ...
    creators: "Van Lente, Ching, Francisco, Vilanova",
    writers: "Fred Van Lente",
    artists: "Brian Ching, Eduardo Francisco, Guiu Vilanova",
    description: "",
  ...
  },
  {
    ...
    releaseDate: { year: 2022, month: 1 },
    creators: "Van Lente, Bunn, Ching, Davila",
    writers: "Fred Van Lente, Cullen Bunn",
    artists: "Brian Ching, Sergio Davila",
    description: "",
  ...
  // --- King Conan Chronicles ---
  {
    ...
    creators: "Dysart, Truman, Gischler, Conrad, Giorello, Futaki",
    writers: "Joshua Dysart, Timothy Truman",
    artists: "Victor Gischler, Will Conrad, Tomas Giorello, Attila Futaki",
    description: "",
  ...
  // --- Planet of the Apes Adventures ---
  {
    ...
    creators: "Moench, Tuska, Alcala",
    writers: "Doug Moench",
    artists: "George Tuska, Alfredo Alcala",
    description: "",
  ...
  },
  {
    ...
    creators: "Mantlo, Duffy, Grant, Buscema, LaRocque, Broderick",
    writers: "Bill Mantlo, Jo Duffy, Steven Grant",
    artists: "Sal Buscema, Greg LaRocque, Pat Broderick",
  ...
  },
  {
    ...
    creators: "Mantlo, Buscema, Bright, Ditko, Johnson",
    writers: "Bill Mantlo",
    artists: "Sal Buscema, Mark Bright, Steve Ditko, William Johnson",
  ...
  // --- Micronauts ---
  {
    ...
    creators: "Mantlo, Golden, Chaykin",
    writers: "Bill Mantlo",
    artists: "Michael Golden, Howard Chaykin",
  ...
  },
  {
    ...
    creators: "Mantlo, Kane, Guice",
    writers: "Bill Mantlo",
    artists: "Gil Kane, Butch Guice",
  ...
  },
  {
    ...
    creators: "Gillis, Jones",
    writers: "Peter B. Gillis",
  ...
  },
  {
    ...
    creators: "Richardson, Willis",
    writers: "Mike Richardson",
    artists: "Damon Willis",
  ...
  },
  {
    ...
    releaseDate: { year: 2025, month: 11 },
    creators: "Grant, Woodring, Edginton, Taylor, Plunkett, Simpson",
  ...
  },
  {
    ...
    creators: "Warner, Puckett, Guinan, Jolley, Akins, Nunis, Nadeau",
    writers: "Chris Warner, Kelley Puckett, Paul Guinan, Dan Jolley, TBC",
    artists: "Tony Akins, Allen Nunis, John Nadeau, TBC",
